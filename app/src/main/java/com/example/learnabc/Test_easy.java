...
public class Test_easy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName=findViewById(R.id.tv_question_explain_testEasy);
        item=findViewById(R.id.img_hint_test_testEasy);
    ...
    public int questionO(){
        ...
        itemFor=MediaPlayer.create(this,R.raw.orange);
    ...
    public void button1(View view){choice=1;answerMade=true; test();}

    public void button2(View view){choice=2; answerMade=true; test();}

    public void button3(View view){choice=3; answerMade=true; test();}

    public void button4(View view){choice=4; answerMade=true; test();}
    ...
    public void test(){
        ...
        if (counter==11){
            Intent intent = new Intent(Test_easy.this, Result.class);
    ...
    public void checkAns(){
        if (answer==choice){
            ...
            final LodingScreen lodingScreen = new LodingScreen(Test_easy.this);
        ...
        //Return value error, other ok, verification need double check
            ...
            final LodingScreenWrong lodingScreen = new LodingScreenWrong(Test_easy.this);
            lodingScreen.startLodingDialog();
            Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
